package com.agame.services.work
{
	...
	[Event(name = "WorkEvent_Queue_Start", type = "com.agame.services.work.WorkFlowEvent")]
	[Event(name = "WorkEvent_Queue_COMPLETE", type = "com.agame.services.work.WorkFlowEvent")]
	[Event(name = "WorkEvent_Queue_Failed", type = "com.agame.services.work.WorkFlowEvent")]
	[Event(name = "WorkEvent_Start", type = "com.agame.services.work.WorkFlowEvent")]
	[Event(name = "WorkEvent_Complete", type = "com.agame.services.work.WorkFlowEvent")]
	[Event(name = "WorkEvent_Failed", type = "com.agame.services.work.WorkFlowEvent")]
	public class Workflow extends EventDispatcher
	{
		...
		protected function workEventHandler(e:Event):void
		{
			...
			if (target == null)
				return;
			var errorSkip:Boolean = _workParams[_currentCount]; //是否跳过错误
