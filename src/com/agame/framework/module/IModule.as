package com.agame.framework.module
{
	...
	public interface IModule
	{
		 ...
		 * resource:  当前模块的资源文件
		 * **/
		function startup(app:Application, container:*, resource:Resource = null):void;
		
		/**
		 * 通过协议执行 
		 * @param protocol API执行协议
		 * 
		 */		
		function executeWithProtocol(protocol:ModuleAPIProtocol):void;
